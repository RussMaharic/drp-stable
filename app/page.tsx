      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            Multi-Supplier
            <span className="text-blue-600 dark:text-blue-400"> E-commerce Platform</span>
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Connect suppliers and sellers in one powerful platform. Manage products, 
            streamline operations, and grow your business with our comprehensive solution.
          </p>
        </div>
